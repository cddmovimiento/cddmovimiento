...
class employee_loan_type(models.Model):
    ...
    loan_limit = fields.Float('Límite del monto del deducción', default=50000)
    loan_term = fields.Integer('Plazo de la deducción', default=12)
    ...
    periodo_de_pago = fields.Selection([('Semanal','Semanal'), ('Quincenal','Quincenal')], string='Periodo de pago')
